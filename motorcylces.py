...
print(f"The last motorcycle that I bought was a brand new "
    f"{last_owned.title()}.")

#Using the pop() method on a specific index
motorcycles = ['honda', 'yamaha', 'suzuki']
second_owned = motorcycles.pop(1)
print(f"The second motorcycle I ever owned was a real sleek "
    f"{second_owned.title()}.")
...
print(motorcycles)
print(f"I never did own a {too_expensive.title()}, though. Those "
    "bastards are way too expensive.")